 ...
 */
export type NormalizedChatClientOptions = Modify<ChatClientOptions, {
    logLevel: LogLevel;
}>;
export declare const normalizeClientOptions: (options?: ChatClientOptions) => NormalizedChatClientOptions;
export {};
