import { ChatMessageAction, ChatMessageEvent, MessageReactionSummaryEvent } from './events.js';
...
export declare class DefaultMessage implements Message {
    ...
    readonly reactions: MessageReactions;
    readonly operation?: Operation;
    constructor({ serial, clientId, text, metadata, headers, action, version, createdAt, timestamp, reactions, operation, }: DefaultMessageParams);
    get isUpdated(): boolean;
    get isDeleted(): boolean;
    get updatedBy(): string | undefined;
    get deletedBy(): string | undefined;
     ...
     */
    private _getLatestMessageVersion;
