 ...
 */
export declare enum ChatMessageEventType {
 ...
 */
export declare enum RealtimeMessageName {
 ...
 */
export declare enum RealtimeMetaEventType {
 ...
 */
export declare enum ChatMessageAction {
 ...
 */
export declare enum TypingEventType {
    /**
 ...
 */
export declare enum TypingSetEventType {
    /**
 ...
 */
export declare enum RoomReactionRealtimeEventType {
    /**
 ...
 */
export declare enum RoomReactionEventType {
    /**
     * Event triggered when a room reaction was received.
     */
    Reaction = "reaction"
 ...
 */
export declare enum ReactionAnnotationType {
 ...
 */
export declare const AnnotationTypeToReactionType: Record<string, MessageReactionType>;
/**
 * Enum representing different message reaction events in the chat system.
 * @enum {string}
 */
export declare enum MessageReactionEventType {
    /**
 ...
 */
export declare enum OccupancyEventType {
    /**
